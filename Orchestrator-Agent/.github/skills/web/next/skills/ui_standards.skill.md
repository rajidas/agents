...
Follow W3C WCAG 2.0, 2.1, and 2.2 by default, targeting WCAG 2.2 Level AA and
preserving applicable 2.0 and 2.1 success criteria. Record the relevant WCAG
version and success-criterion IDs for accessibility requirements and tests.
